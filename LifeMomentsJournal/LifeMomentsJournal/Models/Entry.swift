...
struct Entry: Identifiable {
    ...
    static func getMockData() -> [Entry] {
        let mockData: [Entry] = [
            ...
            .init(date: "TUE 13", title: "Zakopane Z Zakop Zakopane Zakopane Z Zakop Zakopane Zakopane Z Zakop Zakopane", content: "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum is simply dummy text. Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum is simply dummy text.", image: "study"),
